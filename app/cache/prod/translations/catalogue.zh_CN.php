...
$catalogue = new MessageCatalogue('zh_CN', array (
  ...
  array (
    ...
    'This value should be the user current password.' => '该变量的值应为用户当前的密码。',
  ...
  array (
    ...
    'profile.show.name' => '真实姓名',
    'profile.show.job' => '我的工作',
    'profile.show.qq' => 'QQ号',
    'profile.edit.edit_item' => '更新资料',
    'profile.edit.submit' => '更新',
    'profile.flash.updated' => '用户信息已更新',
    'profile.my_profile' => '我的个人资料',
    'profile.my_profile_change' => '修改资料',
...
',
    ...
    'link.forget_password' => '找回密码',
    'link.activation' => '激活账号',
  ),
  'FOSCommentBundle' => 
  array (
    'fos_comment_comment_new_headline_first' => '抢沙发',
    'fos_comment_comment_new_headline' => '发表新讨论',
    ...
    'fos_comment_comment_show_by' => '署名：',
    'fos_comment_comment_show_voteup' => '顶',
    'fos_comment_comment_show_votedown' => '踩',
    'fos_comment_comment_show_reply' => '回复',
    'fos_comment_comment_vote_score' => '分数：',
    'fos_comment_comment_tree_load_more' => '加载更多回复',
    'Showing %num% comment|Showing %num% comments' => '显示 %num% 条讨论|显示 %num% 条讨论',
    'fos_comment_rss_feed' => 'RSS源',
    'fos_comment_thread_close' => '关闭话题',
    'fos_comment_thread_open' => '打开话题',
    'fos_comment_thread_comment_count' => '%count% 条讨论|%count% 条讨论',
    'fos_comment_comment_edit' => '编辑',
    'fos_comment_comment_delete' => '删除',
    'fos_comment_comment_undelete' => '取消删除',
    'fos_comment_comment_deleted' => '[已删除]',
  ),
));
