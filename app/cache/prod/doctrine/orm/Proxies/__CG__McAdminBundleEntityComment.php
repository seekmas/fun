 ...
 */
class Comment extends \Mc\AdminBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'thread', 'ancestors', 'parent', 'body', 'depth', 'createdAt', 'state', 'previousState');
        }
