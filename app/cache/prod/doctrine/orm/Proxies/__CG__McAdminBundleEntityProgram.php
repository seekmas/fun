 ...
 */
class Program extends \Mc\AdminBundle\Entity\Program implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'subject', 'summary', 'view', 'sortId');
        }
    ...
    public function setSortId($sortId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSortId', array($sortId));
    ...
    public function getSortId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSortId', array());
