...
<form action=\"";
   ...
   \t
    ...
    \t<label>";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "current_password"), 'label');
        echo "</label>
    \t<div>";
        // line 11
...
\t        <label>";
            // line 16
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["passwordField"]) ? $context["passwordField"] : null), 'label');
            echo "</label>
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["x"]) {
            // line 23
            echo "\t\t";
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["x"]) ? $context["x"] : null), 'widget');
            echo "
\t";
        }
        $_parent = $context['_parent'];
