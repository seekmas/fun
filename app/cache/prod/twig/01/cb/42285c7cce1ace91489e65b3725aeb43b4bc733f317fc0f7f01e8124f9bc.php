...
class __TwigTemplate_01cb42285c7cce1ace91489e65b3725aeb43b4bc733f317fc0f7f01e8124f9bc extends Twig_Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["key"] => $context["u"]) {
            // line 7
            echo "        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("admin_unit_edit", array("id" => $this->getAttribute((isset($context["u"]) ? $context["u"] : null), "id"))), "html", null, true);
            echo "\">";
...
";
    ...
    ";
        ...
        <div class=\"control-group\">
            ";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["edit_form"]) ? $context["edit_form"] : null), 'row');
        echo "
        </div>
